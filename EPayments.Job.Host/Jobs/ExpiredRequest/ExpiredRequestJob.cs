            ...
            while (requestIds.TryDequeue(out requestId))
            {
                ...
                try
                {
                    using (var factory = this.dependencyFactory())
                    {
                        ...
                        EPayments.Model.Models.PaymentRequest paymentRequest = jobRepository.GetRequestById(requestId);
                        ...
                        {
                            EPayments.Model.Models.EserviceNotification statusNotification = new EPayments.Model.Models.EserviceNotification(paymentRequest);
