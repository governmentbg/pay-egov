...
namespace EPayments.Data.Repositories.Interfaces
{
    public interface IApiRepository : IBaseRepository
    {
        ...
        List<Tuple<int, RequestPaymentInfoParsedVO>> GetParsedPendingPaymentRequestInfosByApplicant(string applicantUin);

        List<Tuple<int, RequestPaymentInfoParsedVO>> GetParsedPaymentRequestInfosByApplicant(string applicantUin);
