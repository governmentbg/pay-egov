...
namespace EPayments.Data.Repositories.Interfaces
{
    public interface IEquationControlsRepository
    {
        ...
        Task<int> CountBoricaTransactions(DateTime? dateFrom,
            DateTime? dateTo,
            int? transactionStatus);
        ...
        Task<decimal> GetTransactionsAmounts(DateTime? dateFrom,
            DateTime? dateTo,
            int? transactionStatus);

        Task<decimal> GetTransactionsFees(DateTime? dateFrom,
            DateTime? dateTo,
            int? transactionStatus);

        Task<decimal> GetTransactionsCommissions(DateTime? dateFrom,
            DateTime? dateTo,
            int? transactionStatus);
    }
}
