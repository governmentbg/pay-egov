...
{
    public class APGWEndingAuthorizationDataVO : APGWRequestBase
    {
        private string _rrn;
        ...
        [Display(Name = "TRTYPE")]
        public override TrTypeEnum TrType => TrTypeEnum.EndingAuthorization;
        ...
        public string ADDENDUM
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("ADDENDUM value is required, and it maximum length is 5.");
                }
        ...
        {
            return base.AddNextKeyToPSign(this.Terminal) +
