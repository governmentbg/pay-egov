...
{
    public class APGWReversalPaymentRequestDataVO : APGWRequestBase
    {
        ...
        [Display(Name = "TRTYPE")]
        public override TrTypeEnum TrType => TrTypeEnum.Reversal;
        ...
        {
            string pSign = base.AddNextKeyToPSign(this.Terminal) +
                base.AddNextKeyToPSign(((int)this.TrType).ToString()) +
                base.AddNextKeyToPSign(this.Amount.ToString()) +
