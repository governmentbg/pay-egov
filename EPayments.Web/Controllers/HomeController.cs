                ...
                case "ruleselectronicservicepdf":
                    {
                        ...
                        saveFileName = "Общи условия за присъединяване на административни органи и на доставчици на платежни услуги към Единната входна точка за електронни плащания в централната и местната администрация и използване на функционалността 'Централен ВПОС терминал', предоставяна от Държавна агенция 'Електронно управление'.pdf";
                ...
                case "apppaymentservicecvpospdf":
                    {
                        ...
                        saveFileName = "Заявление за присъединяване на доставчик на платежни услуги към Единната входна точка за електронни плащания в централната и местната администрация(Единната входна точка) чрез използване на функционалността 'Централен виртуален ПОС терминал', предоставяна от Държавна агенция 'Електронно управление' (ДАЕУ).pdf";
                        mimeType = MimeTypeFileExtension.MIME_APPLICATION_PDF;
                        break;
                    }
                ...
                case "procedureborikapdf":
                    {
                        ...
                        saveFileName = "ПРОЦЕДУРА ПО 'ОСПОРВАНЕ НА ПЛАЩАНЕ', ИЗВЪРШЕНО ЧРЕЗ ВИРТУАЛНОТО ТЕРМИНАЛНО ПОС УСТРОЙСТВО ПРЕДОСТАВЕНО НА ДЪРЖАВНА АГЕНЦИЯ 'ЕЛЕКТРОННО УПРАВЛЕНИЕ', БСЛУЖВАНО ОТ 'БОРИКА' АД.pdf";
                        mimeType = MimeTypeFileExtension.MIME_APPLICATION_PDF;
                        break;
                    }
