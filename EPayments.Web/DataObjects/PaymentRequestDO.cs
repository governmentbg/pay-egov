...
namespace EPayments.Web.DataObjects
{
    public class PaymentRequestDO : IValidatableObject
    {
        ...
        [MaxLength(50, ErrorMessage = "Тип на документа не може да е по-дълът от {1} символа.")]
        ...
        [Display(Name = "Референтен номер на плащането")]
        ...
        [Display(Name = "Име на задълженото лице")]
