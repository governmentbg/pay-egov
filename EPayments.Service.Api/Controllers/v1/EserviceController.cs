...
namespace EPayments.Service.Api.Controllers.v1
{
    ...
    public class EserviceController : ApiController
    {
        ...
        public object PostPaymentJsonExtended(AuthRequestExtendedDO requestDO)
        {
            ...
            Tuple<R_10052.PaymentRequestUnacceptedReceipt, R_10055.PaymentRequestAcceptedReceipt> receiptsTuple =
                InternalPostPayment(requestDO, requestXmlContent, paymentRequestJson.AisPaymentId, true, requestDO.EserviceClientId);
        ...
        public object PostPendingPaymentStatusJson(AuthRequestDO requestDO)
        {
            ...
            var pendingRequestTuples = this.apiRepository.GetParsedPendingPaymentRequestInfosByApplicant(applicantUin);

            return new
            {
                PaymentStatuses = pendingRequestTuples.Select(r => new { paymentrequestID = r.Item1, result = r.Item2 }).ToList()
            };
        }
        ...
        public object PostPaymentStatusJson(AuthRequestDO requestDO)
        {
            ...
            var pendingRequestTuples = this.apiRepository.GetParsedPaymentRequestInfosByApplicant(applicantUin);
            ...
            string eServiceClientId = null)
        {
            ...
            List<string> validationErrors = DocumentHelper.ValidatePaymentRequestData(apiRepository, requestRio, еserviceClient.EserviceClientId, aisPaymentId, out request);
        ...
        private void SetPaymentRequestAttributes(PaymentRequest request, R_10046.PaymentRequest requestRio, Tuple<UinType, string, string> uinData)
        {
            ...
            request.ApplicantName = uinData.Item3;
